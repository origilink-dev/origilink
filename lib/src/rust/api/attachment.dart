...
// These functions are ignored because they are not marked as `pub`: `blossom_auth_event`, `decrypt_attachment_bytes`, `default_upload_server_urls`, `delete_blossom_blob`, `download_ciphertext`, `download_encrypted_link`, `encrypt_attachment_bytes`, `http_client`, `upload_and_send`, `upload_ciphertext`, `upload_encrypted_link`, `upload_plain_bytes`, `upload_server_path`, `upload_servers_path`
